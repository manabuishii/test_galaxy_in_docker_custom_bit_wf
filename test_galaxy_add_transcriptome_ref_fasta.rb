...
class GalaxyTest < Test::Unit::TestCase
  ...
  def test_galaxy
    ...
    #### Select transcriptome_ref_fasta for Server Directory
    options.each do |g|
      if g.text == "transcriptome_ref_fasta"
        g.click
        break
      end
    end
