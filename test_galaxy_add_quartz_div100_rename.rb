...
class GalaxyTest < Test::Unit::TestCase
  ...
  def test_galaxy
    ...
    element.click
    # send enter needs. but I don't know why.
    ...
    #### Select quartz_div100_rename for Server Directory
    options.each do |g|
      if g.text == "quartz_div100_rename"
        g.click
        break
      end
    end
